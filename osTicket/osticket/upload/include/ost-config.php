...
define('SECRET_SALT','7iSJiFuYLhz7EW0ppcLvqI4E4JrB5tAD');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','jakob@secnd.me');

# Database Options
# ---------------------------------------------------
# Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','192.168.0.33');
define('DBNAME','osticket');
define('DBUSER','osticketadmin');
define('DBPASS','famfamfam');
