...
%Tryout package imports, for embedding systemdoku:
...
\newcommand\getHammerl{Helmut Hammerl}
\newcommand\getOst{OSTicket}
\newcommand\getAlex{Alexander Scharmer}
\newcommand\getSteff{Stefan Stolz}
...
%TODO: 0 Jeden \\ mit \paragraph{} ersetzen!!!
